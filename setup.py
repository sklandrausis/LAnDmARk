    ...
    for id in SASidsCalibrator:
        ...
        for line in parset_file:
            if "! cal_input_path" in line:
                ...
                parset_file[parset_file.index(line)] = line.replace(line, "! inspection_directory            = " + "{{ results_directory }}/" + "cal_values_" + id + " ## directory of the prefactor outputs\n")
            elif "! cal_values_directory" in line:
                parset_file[parset_file.index(line)] = line.replace(line, "! cal_values_directory            = " + "{{ results_directory }}/" + "inspection_" + id + " ## directory of the prefactor outputs\n")
