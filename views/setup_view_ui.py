...
class Ui_setup_view(object):
    ...
    def retranslateUi(self, setup_view):
        ...
        self.select_subband_range_combobox.setItemText(0, _translate("setup_view", "True"))
        self.select_subband_range_combobox.setItemText(1, _translate("setup_view", "False"))
