...
class Ui_setup_view(object):
    def setupUi(self, setup_view):
        ...
        self.select_subband_range_combobox = QtWidgets.QComboBox(setup_view)
        self.select_subband_range_combobox.setGeometry(QtCore.QRect(160, 360, 141, 36))
        self.select_subband_range_combobox.setMaxVisibleItems(10)
        self.select_subband_range_combobox.setObjectName("select_subband_range_combobox")
        self.select_subband_range_combobox.addItem("")
        self.select_subband_range_combobox.addItem("")
        self.select_subband_range_label = QtWidgets.QLabel(setup_view)
        ...
        self.min_subband_input.setText("")
        self.min_subband_input.setObjectName("min_subband_input")
        self.max_subband_label = QtWidgets.QLabel(setup_view)
        self.max_subband_label.setGeometry(QtCore.QRect(160, 460, 111, 20))
        self.max_subband_label.setObjectName("max_subband_label")
        self.max_subband_input = QtWidgets.QLineEdit(setup_view)
    ...
    def retranslateUi(self, setup_view):
        ...
        self.select_subband_range_combobox.setItemText(0, _translate("setup_view", "False"))
        self.select_subband_range_combobox.setItemText(1, _translate("setup_view", "True"))
