...
class Ui_check_view(object):
    def setupUi(self, check_view):
        ...
        self.choose_combobox.setGeometry(QtCore.QRect(0, 10, 231, 36))
        ...
        self.inspection_plots_combobox.setGeometry(QtCore.QRect(0, 60, 301, 36))
        self.inspection_plots_combobox.setObjectName("inspection_plots_combobox")
        self.inspection_plot = QtWidgets.QLabel(self.centralwidget)
        self.inspection_plot.setGeometry(QtCore.QRect(340, 10, 581, 381))
        self.inspection_plot.setScaledContents(True)
        self.inspection_plot.setObjectName("inspection_plot")
    ...
    def retranslateUi(self, check_view):
        ...
        self.inspection_plot.setText(_translate("check_view", "<html><head/><body><p><br/><src/></p></body></html>"))
