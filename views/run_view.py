...
class RunView(QMainWindow):
    def __init__(self):
        ...
        if getConfigs("Operations", "querying", config_file) == "True" and getConfigs("Operations", "stage", config_file) == "False":
            self._ui.show_query_progress_button.setStyleSheet("background-color: green")
            ...
            self._ui.show_query_progress_button.setStyleSheet("background-color: green")
            self._ui.show_stage_progress_button.setStyleSheet("background-color: blue")
            self._ui.show_query_progress_button.setDisabled(False)
            ...
            self._ui.show_query_progress_button.setStyleSheet("background-color: green")
            self._ui.show_stage_progress_button.setStyleSheet("background-color: blue")
            self._ui.show_retrieve_progress_button.setStyleSheet("background-color: blue")
            self._ui.show_query_progress_button.setDisabled(False)
            ...
            self._ui.show_stage_progress_button.setStyleSheet("background-color: blue")
            self._ui.show_retrieve_progress_button.setStyleSheet("background-color: blue")
            self._ui.show_process_progress_button.setStyleSheet("background-color: blue")
            self._ui.show_query_progress_button.setDisabled(False)
